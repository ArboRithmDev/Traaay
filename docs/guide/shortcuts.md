...
> [!NOTE]
> Traaay n'installe aucun raccourci clavier global. Toutes les actions décrites ici sont des gestes à la souris, éventuellement combinés à la touche ⌘.

---

## Matrice des Actions dans la Palette Top Traaay

| Geste | Cible normale (Icône visible) | Cible sous l'encoche (⚠️) |
| :--- | :--- | :--- |
...
- Pour y accéder, dépliez de l'espace avec le séparateur ou utilisez le geste `⌘+Clic`.
