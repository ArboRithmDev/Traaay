...
> [!NOTE]
> Traaay registers no global keyboard shortcuts. Every action described here is a mouse gesture, optionally combined with the ⌘ key.

---

## Interaction Matrix in Top Traaay

| Gesture | Standard Item (Visible) | Item Under Notch (⚠️) |
| :--- | :--- | :--- |
